...
namespace app\admin\controller\incoming;
...
class Stock extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\incoming\Stock;
            ...
            for ($currentRow = 2; $currentRow <= $allRow; $currentRow++) {
                ...
                foreach ($temp as $k => $v) {
                    if (isset($fieldArr[$k]) && $k !== '') {
                        // 修复时间格式
                        if ($fieldArr[$k] == 'entry_time' || $fieldArr[$k] == 'expiry_date' || $fieldArr[$k] == 'storage_time') {
                            if (is_numeric($v)) {
